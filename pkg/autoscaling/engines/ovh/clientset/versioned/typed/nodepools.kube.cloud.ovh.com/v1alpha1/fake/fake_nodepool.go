...
type FakeNodePools struct {
	Fake *FakeOVHV1alpha1
}

var nodepoolsResource = schema.GroupVersionResource{Group: "nodepools.kube.cloud.ovh.com", Version: "v1alpha1", Resource: "nodepools"}

var nodepoolsKind = schema.GroupVersionKind{Group: "nodepools.kube.cloud.ovh.com", Version: "v1alpha1", Kind: "NodePool"}

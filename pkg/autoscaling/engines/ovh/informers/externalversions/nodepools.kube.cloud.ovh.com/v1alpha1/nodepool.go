...
import (
	...
	nodepoolskubecloudovhcomv1alpha1 "github.com/containership/cerebral/pkg/apis/nodepools.kube.cloud.ovh.com/v1alpha1"
	...
	v1alpha1 "github.com/containership/cerebral/pkg/autoscaling/engines/ovh/listers/nodepools.kube.cloud.ovh.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OVHV1alpha1().NodePools().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OVHV1alpha1().NodePools().Watch(options)
			},
		},
		&nodepoolskubecloudovhcomv1alpha1.NodePool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nodepoolskubecloudovhcomv1alpha1.NodePool{}, f.defaultInformer)
}

...
import (
	...
	kubecloudovhcomv1alpha1 "github.com/containership/cerebral/pkg/apis/kube.cloud.ovh.com/v1alpha1"
	...
	v1alpha1 "github.com/containership/cerebral/pkg/autoscaling/engines/ovh/listers/kube.cloud.ovh.com/v1alpha1"
...
func NewFilteredNodePoolInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&kubecloudovhcomv1alpha1.NodePool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubecloudovhcomv1alpha1.NodePool{}, f.defaultInformer)
}
